...
import { teamImplementation, teamStrategic } from "../data/team-data";

export default function Team() {
  return (
    <>
      <div
        className="custom-container px-2 px-sm-2 px-md-5 px-lg-5 px-xl-5"
        id="team"
      >
        ...
        <div className="">
          <div className="mt-5 pt-5">
            <h2 className="common-sub-heading">
              <span className="common-color">Strategy & Operations</span>
            </h2>
          </div>
          <div className="row">
            {teamStrategic.map((data) => {
              return (
                <div className="col-12 col-md-6 col-lg-6 col-xl-3 d-flex justify-content-center mt-5">
                  <Card>
                    <Card.Body>
