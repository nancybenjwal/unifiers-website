...
import testimonials from "../images/randon/testimonials.png"
    ...
    <>
      <div className="custom-container">
        <div className="mt-5 pt-5">
          ...
          <h2 className="common-sub-heading text-center">Consulting</h2>
      ...
      <div className="mt-5 mb-5 pb-5">
        <h2 className="common-sub-heading text-center">
          Client <span className="common-color">Testimonials</span>
        </h2>
        <img src={testimonials} className="img-fluid mt-5 pt-5" />
      </div>
    </>
  )
}
