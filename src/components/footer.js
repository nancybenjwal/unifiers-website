          ...
          <Col className="col-12 col-sm-12 col-md-7 col-lg-3  col-xl-2 col-xxl-2 mt-4 pt-4">
            ...
            <div className="footer-common-text mt-2">
              <Row>
                <Col className="col-3">
                  <a
                    href="https://www.facebook.com/profile.php?id=100087768012063"
                    target="_blank"
                ...
                <Col className="col-3">
                  <a
                    href="https://www.instagram.com/unifiers.in/?igshid=NTdlMDg3MTY%3D"
                    target="_blank"
                    className="text-white"
                  >
                    <svg
                ...
                <Col className="col-3">
                  <a
                    href="https://www.linkedin.com/company/unifiers-social-ventures/"
                    target="_blank"
                    className="text-white"
                  >
                    <svg
                ...
                <Col className="col-3">
                  <a
                    href="https://twitter.com/unifiers_in?t=ygpBkUUWAp434QQDVcepyg&s=09"
                    target="_blank"
                    className="text-white"
                  >
                    <svg
